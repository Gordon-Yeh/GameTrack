        ...
        return (
            <Jumbotron>
                ...
                >
                    ...
                    <Form.Row>
                        <Form.Group as={Col} event md="4" controlId="validationCustom03">
                            <Form.Label>Location</Form.Label>
                            {/* { todo make it a dropdown to select from locations we have} */}
                            <Form.Control type="text" placeholder="Location Name" required />
                        </Form.Group>
                        <Form.Group as={Col} event md="4" controlId="validationCustomUsername">
                        ...
                        <Form.Group as={Col} event md="3" controlId="validationCustom05">
